...
from utils.styling import (
    ...
    ORANGE, ORANGE_LIGHT, TEAL, RED, BLUE_SOFT,
    BEIGE_MUTED, BEIGE, BORDER, GRID_COLOR,
    PLOTLY_PAPER, PLOTLY_PLOT, BG_CARD,
    # legacy aliases
    TEXT_MUTED, NAVY_LIGHT, TEXT_MAIN, NAVY_CARD,
    PLOTLY_PAPER_BG, PLOTLY_PLOT_BG,
)
